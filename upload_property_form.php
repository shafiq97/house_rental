...
<body>
  ...
  <div class="inside-banner">
    <div class="container">
      <h2>Upload your property information</h2>
    </div>
  </div>
          ...
          <div class="row">
            <form action="api.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input required type="text" class="form-control" name="property_title">
              </div>
              <!-- Property details -->
              <div class="form-group">
                <label>Property Details</label>
                <input required type="text" class="form-control" name="property_details">
              </div>
              <!-- Delivery type -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input required type="textbox" class="form-control" name="property_address">
              </div>
              <!-- Property Image -->
              <div class="form-group">
                <label>Property Image</label>
                <input required type="File" class="form-control" name="property_image">
              </div>
              <!-- Property bed room -->
              <div class="form-group">
                <label>No of bed room</label>
                <input required type="number" class="form-control" name="bed_rooms">
              </div>
              <!-- Property living room -->
              <div class="form-group">
                <label>No of living room</label>
                <input required type="number" class="form-control" name="living_rooms">
              </div>
              <!-- Property parking -->
              <div class="form-group">
                <label>No of parking</label>
                <input required type="number" class="form-control" name="no_of_parking">
              </div>
              <!-- Property kitchen -->
              <div class="form-group">
                <label>No of kitchen</label>
                <input required type="number" class="form-control" name="no_of_kitchen">
              </div>
              <!-- Property utility -->
              <div class="form-group">
                <label>Utilities</label>
                <input required type="text" class="form-control" name="utilities">
              </div>
              <!-- Property type -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input required type="text" class="form-control" name="floor_space">
              </div>
              <!-- Property details -->
              <div class="form-group">
              ...
              <button type="submit" name="insert_property_details" class="btn btn-primary">Submit</button>
            </form>
          </div>
        </div>
      </div>
