...
<head>
<title>Search Result - <?php echo $_SESSION['website_name'] ?></title>
<meta charset="UTF-8" />
     ...
     <!-- properties -->
      ...
      <div class="properties">
        <div class="image-holder"><img src="<?php echo $property_img; ?>" class="img-responsive" alt="properties">
          <?php if($availablility == 0){ ?><div class="status sold">Not Available</div> <?php } else { ?>
...
<span class="glyphicon glyphicon-earphone"></span> +60182639906</p>
            </div>
        </div>
