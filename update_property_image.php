          ...
          <div class="row">
            <form action="api.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input readonly="true" required type="text" class="form-control" name="property_title" value="<?php echo $property_title ?>">
                <input type="hidden" class="form-control" name="property_id" value="<?php echo $property_id ?>">
              </div>
              <!--  -->
              <div class="form-group">
                <label>Upload your image</label><br>
                <small>You can upload multiple image</small>
                <input required type="file" multiple="multiple" class="form-control" name="prop_images[]" value="<?php echo $property_title ?>">
              </div>
              <button type="submit" name="update_property_images" class="btn btn-primary">Update</button>
            </form>
          </div>
        </div>
      </div>
